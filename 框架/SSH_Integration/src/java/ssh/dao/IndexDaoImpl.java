...
public class IndexDaoImpl implements IndexDao {
    ...
    public List<BookCard> getAllBookCard() {
        ...
        session.createQuery("delete from  BookCard  where cid=1");
        //final Query query1 = session.createQuery("insert into  BookCard (cid,name,sex,cardDate,deposit) values(1,2,1,1997-12-12,'12')");
